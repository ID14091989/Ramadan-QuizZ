const questions = [
    ...
    },
    {
        ...
        answers: [
            "Rompre le jeûne durant la journée de Ramadhan sans excuse valable représente un péché capital, et de fait celui qui s'en rend coupable est considéré comme dévoyé. Il lui incombe de se repentir à Allah, de rattraper ce jour de jeûne manqué."
        ],
        correct: 0
    },
    {
        question: "Que doit faire la personne qui n'a pas jeûné en raison d'une incapacité ou maladie passagère, ou bien en raison d'un empêchement passager ou en raison d'un voyage ?",
        answers: [
            "Ces catégories de personnes doivent uniquement rattraper les jours non jeûnés et n'ont pas à nourrir de pauvres en compensation, car leur maladie ou leur empêchement n'est que passager."
        ],
        correct: 0
    },
    {
